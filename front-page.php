...
<div class="lfa-announcement"><div class="container"><?php echo esc_html($txt); ?></div></div>
<?php endif; ?>
...
<?php $cats = $H('shop_by_category.items', []); $cats = is_array($cats)?array_values(array_filter($cats,fn($i)=>!empty($i['image']))):[]; $cats = array_slice($cats,0,4); ?>
<?php if ($cats): ?>
<section class="lfa-sbc container">
  <div class="lfa-sec-head"><h2><?php _e('Shop by Category','livingfitapparel'); ?></h2></div>
...
<section class="lfa-featured container">
  <div class="lfa-sec-head"><h2><?php _e('Featured Products','livingfitapparel'); ?></h2><?php if (function_exists('wc_get_page_id')): ?><a class="lfa-viewall" href="<?php echo esc_url(get_permalink(wc_get_page_id('shop'))); ?>"><?php _e('View All','livingfitapparel'); ?></a><?php endif; ?></div>
...
<section class="lfa-story container">
  <div class="lfa-sec-head"><h2><?php _e('Our Story','livingfitapparel'); ?></h2></div>
...
<section class="lfa-bycolor container">
  <div class="lfa-sec-head">
    ...
    <div class="lfa-chips" data-color-tabs>
      <?php $first=true; foreach ($terms as $t): ?>
...
<?php $fyf = $H('find_your_fit.items', []); $fyf = is_array($fyf)?array_values(array_filter($fyf,fn($i)=>!empty($i['image']))):[]; ?>
<?php if ($fyf): ?>
<section class="lfa-fyf container">
  <div class="lfa-sec-head"><h2><?php _e('Find your fit','livingfitapparel'); ?></h2></div>
...
<section class="lfa-reviews container">
  <div class="lfa-sec-head"><h2><?php _e('Customer Reviews','livingfitapparel'); ?></h2></div>
