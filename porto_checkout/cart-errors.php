...
<p><a class="button wc-backward btn-v-dark font-weight-normal text-capitalize px-4" href="<?php echo esc_url( wc_get_cart_url() ); ?>"><?php esc_html_e( 'Return to cart', 'woocommerce' ); ?></a></p>
